...
- [3. Architecture Approach](#3-Architecture-Approach)
    - [3.1 Frontend](#31-frontend-ratatui-tui-and-cli)
        - [3.2 Backend](#32-backend-axum-https-service)
        - [3.3 Database ](#33-database-postgresql-with-sqlx)
        - [3.4 Deployment](#34-deployment-docker-and-docker-compose-digitalocean)
- [4. Key Features](#4-key-features)
    - [4.1 Account Management](#41-account-management)
    - [4.2 Transaction Recording and Categories](#42-transaction-recording-and-categories)
    - [4.3 Reconciliation and Imports](#43-reconciliation-and-imports)
    - [4.4 Budgeting (Enhancement)](#44-budgeting-enhancement)
    - [4.5 Data Storage and Security](#45-data-storage-and-security)
    - [4.6 Command-Line User Interface (CLI)](#46-command-line-user-interface-cli)
    - [4.7 Deployment (If Time Allows)](#47-deployment-if-time-allows)
- [5. Main Database Schema and Relationships](#5-database-schema-and-relationships)
- [6. Tentative Plan](#6-tentative-plan)
    - [6.1 Team Workflow](#61-team-workflow)
    - [6.2 Division of Responsibilities](#62-division-of-responsibilities)
    - [6.3 Development Process](#63-development-process)
